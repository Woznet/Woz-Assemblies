...
{
    /// <summary>
    /// Provides methods to add and remove fonts from the system.
    /// </summary>
    public static class AddRemoveFonts
    {
        private static IntPtr HWND_BROADCAST = new IntPtr(0xffff);

        /// <summary>
        /// Adds a font resource from the specified file to the system.
        /// </summary>
        /// <param name="fontFilePath">The path to the font file.</param>
        /// <returns>The number of fonts added. Zero indicates failure.</returns>
        [DllImport("gdi32.dll", CharSet = CharSet.Auto)]
        private static extern int AddFontResource(string lpFilename);

        /// <summary>
        /// Removes a font resource from the system.
        /// </summary>
        /// <param name="fontFileName">The name of the font file to remove.</param>
        /// <returns>The number of fonts removed. Zero indicates failure.</returns>
        [DllImport("gdi32.dll", CharSet = CharSet.Auto)]
        ...
        /// <summary>
        /// Posts a message to a window or windows.
        /// </summary>
        ...
        /// <summary>
        /// Adds a font to the system and broadcasts a font change message.
        /// </summary>
        /// <param name="fontFilePath">The path to the font file.</param>
        /// <returns>The number of fonts added. Zero indicates failure.</returns>
        ...
        /// <summary>
        /// Removes a font from the system and broadcasts a font change message.
        /// </summary>
        /// <param name="fontFileName">The name of the font file to remove.</param>
        /// <returns>The number of fonts removed. Zero indicates failure.</returns>
